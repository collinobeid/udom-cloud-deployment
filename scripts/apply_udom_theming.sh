...
docker exec -u 33 "$APP_CONTAINER" php occ config:app:set theming background_color --value="#f4f5f7"
...
echo "Enforcing plain off-white background and Light theme..."
